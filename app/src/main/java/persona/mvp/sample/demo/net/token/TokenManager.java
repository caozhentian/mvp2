package persona.mvp.sample.demo.net.token;

import android.content.Context;
import android.text.TextUtils;

import persona.mvp.sample.demo.app.ProjectApp;
import persona.mvp.sample.demo.constant.ComParamContact;
import personal.ztcao.baseframe.util.ACache;
...
public class TokenManager {
    ...
    public TokenManager() {
        aCache = ACache.get(ProjectApp.Companion.getAppContext() , key);
